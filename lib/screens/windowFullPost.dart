...
class State_windowFullPost extends State<windowFullPost> {
  ...
  void _refreshData() async {
    ...
    for(var i = 0; i < comments.length; i++){
      commentersName.add(await UserFirestore().getUserAttribute(comments[i].cid, "username"));
    }
    setState(() {
      _isLoading = false;
    });
              ...
              child: Column(
                children: [
                  Row(
                      children: [
                        ...
                        Container(
                          ...
                          child: Expanded(
                            child: FutureBuilder(
                              future: Ref_Window.Ref_FirebaseStorage.loadImages(widget.post.uid),
                              builder: (context, snapshot) {
                                if (snapshot.connectionState ==
                                  ...
                                  if (images.isNotEmpty) {
                                    ...
                                    if (widget.post.uid == Ref_Window.Ref_Management.SETTINGS .Get("WND_USER_PROFILE_UID", "-1")) {
                                        ...
                                        Align(
                                          ...
                                          child: Container(
                                            ...
                                            child: ElevatedButton.icon(
                                              ...
                                              onPressed: () {
                                                Ref_Window.Ref_FirebaseStorage.upload("gallery", widget.post.uid);
                                              },
                                              label: const Text(""),
                  ...
                  comments.isEmpty
                      ...
                      : Column(
                          crossAxisAlignment: CrossAxisAlignment.start,
                          children: [Container(constraints: BoxConstraints(
                            maxHeight: MediaQuery.of(context).size.height / 4 , // Adjust height as needed
                      ...
                      Expanded(
                        child: TextFormField(
                          decoration: InputDecoration(
                            labelText: Ref_Window.Ref_Management.SETTINGS.Get("WND_FULL_POST_COMMENT_TEXT_LABEL", "Write a comment..."),
