...
class State_windowSearch extends State<windowSearch> {
  ...
  List<PostModel> filterList() {
    ...
    if(search.isNotEmpty) {
      return loadedPosts.where((element) => element.title.toLowerCase().contains(search)).toList();
    } else {
      return loadedPosts;
    }
  }
                  ...
                  Expanded(
                    child: TextFormField(
                      decoration: InputDecoration(
                        labelText: Ref_Window.Ref_Management.SETTINGS.Get("WND_FULL_POST_COMMENT_TEXT_LABEL", "Search something..."),
                      ...
                      onChanged: (value) {
                        setState(() {filteredPosts = filterList();});
                      },
                    ),
                  ),
                ],
                        ...
                        return Container(
                            child: _isLoading
                                ...
                                : filteredPosts.isEmpty
                                    ? Center(
                                        child: Text(Ref_Window.Ref_Management.SETTINGS.Get("JNL_HOME_TITLE_1", "No Posts !"))
                                    )
                                    : ListView.builder(
                                        itemCount: filteredPosts.length,
                                        itemBuilder: (context, index) {
                                          if (localLikes.length <= index) {
                                            localLikes.add(int.parse(filteredPosts[index].likes));
                                          }
                                          return GestureDetector(
                                            ...
                                            child: Hero(
                                              tag: 'postHero${filteredPosts[index].pid}',
                                              child: Card(
                                                  ...
                                                  children: [
                                                      ...
                                                      child: Row(
                                                        children: [
                                                          ...
                                                          FutureBuilder<String>(
                                                            future: userFirestore.getUserAttribute(filteredPosts[index].uid,'fullName'),
                                                            builder: (context,
                                                                userSnapshot) {
                                                    ...
                                                    ListTile(
                                                      ...
                                                      subtitle: Column(
                                                        ...
                                                        children: [
                                                          Text("Date: ${filteredPosts[index].date}"),
                                                          Text("Free Seats: ${filteredPosts[index].freeSeats}/${filteredPosts[index].totalSeats}"),
                                                          Text("Location: ${filteredPosts[index].location}"),
                                                    ...
                                                    Row(
                                                      ...
                                                      children: [
                                                        if (currentUserUID == filteredPosts[index].uid) ...[
                                                          IconButton(
                                                          ...
                                                          IconButton(
                                                            ...
                                                            icon: FutureBuilder<bool>(
                                                              future: postFirestore.getIsLikedStatus(currentUserUID!,filteredPosts[index]),
                                                              builder: (context, snapshot) {
                                                                if (snapshot.connectionState == ConnectionState.waiting) {
                                                            ...
                                                            onPressed: () async {
                                                              ...
                                                              int updatedLikes = await postManager.toggleActionPost(currentUserUID!,filteredPosts[index], 2);
