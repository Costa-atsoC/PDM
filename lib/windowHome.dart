                                    ...
                                    Container(
                                      ...
                                      child: ListTile(
                                        ...
                                        subtitle: Column(
                                          ...
                                          children: [
                                            Text(
                                                "Date: ${loadedPosts[index]
                                                    .date}"),
                                            Text(
                                                "Free Seats: ${loadedPosts[index]
                                                    .freeSeats}/${loadedPosts[index]
                                                    .totalSeats}"),
                                            Text(
                                                "Location: ${loadedPosts[index]
                                                    .location}"),
                                                ...
                                                FutureBuilder<bool>(
                                                  ...
                                                  builder: (context,
                                                    ...
                                                    if (snapshot
                                                      ...
                                                      // Handle error
                                                      Utils.MSG_Debug(
                                                          'Error checking like status: ${snapshot
                                                              .error}');
                                                      return const Icon(
                                                          Icons
                                                              .favorite_border);
